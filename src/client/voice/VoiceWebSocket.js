...
class VoiceWebSocket extends EventEmitter {
  ...
  connect() {
     ...
     * @type {WebSocket}
     */
    this.ws = new WebSocket(`wss://${this.voiceConnection.authentication.endpoint}?v=4`);
  ...
  onOpen() {
    this.sendPacket({
      ...
      d: {
        server_id: this.voiceConnection.channel.guild?.id || this.voiceConnection.channel.id,
