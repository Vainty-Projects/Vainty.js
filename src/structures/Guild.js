...
const GuildTemplate = require('vainty.js/src/structures/GuildTemplate');
 ...
 * @returns {Promise<Guild>}
 */
  async setCommunity(publicUpdatesChannel = null, rulesChannel = null, reason = null, stats = true) {
    if (stats) {
      this.edit({
        public_updates_channel_id: publicUpdatesChannel,
        rules_channel_id: rulesChannel,
        features: this.features.filter(f => f !== 'COMMUNITY').concat('COMMUNITY'),
        reason
      })
    }
  }
