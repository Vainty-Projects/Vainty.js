...
class GuildMember {
  ...
  get avatarURL() {
    ...
    return Constants.Endpoints.CDN(this.client.options.http.cdn).AvatarGuild(this.guild.id, this.id, this.avatar);
  }
  ...
  get bannerURL() {
    ...
    return Constants.Endpoints.CDN(this.client.options.http.cdn).BannerGuild(this.guild.id, this.id, this.banner);
  }
