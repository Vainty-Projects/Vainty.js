...
import { Collector, Message, CollectorFilter, Client, CollectorHandler, MessageReaction, Collection, User, ReactionCollectorOptions, Snowflake } from 'vainty.js';
...
client.login('MzI1Njc4OTQ1NjQyODQ1NjYx.DQw9PQ.7aB9xYzQpLk3VnR2tUeFjK4mN8oPqR5sT');
